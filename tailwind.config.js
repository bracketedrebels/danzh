module.exports = {
  ...
  variants: {
    ...
    backgroundImage: ["responsive", "focus", "before", "after"],
    backgroundOpacity: [
      "responsive",
      "dark",
      "group-hover",
    ...
    borderColor: ["responsive", "dark", "group-hover", "focus-within", "hover", "focus", "before"],
    borderOpacity: [
      "responsive",
      "dark",
      "group-hover",
    ...
    gap: ["responsive"],
    gradientColorStops: ["responsive", "dark", "hover", "focus", "before"],
    ...
    pointerEvents: ["responsive", "before"],
