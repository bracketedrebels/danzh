module.exports = {
  ...
  variants: {
    ...
    backgroundClip: ["responsive", "before", "after"],
    backgroundColor: [
      "responsive",
      "dark",
      "group-hover",
    ...
    backgroundImage: ["responsive", "focus", "before", "after", "disabled"],
    backgroundOpacity: [
      "responsive",
      "dark",
      "group-hover",
    ...
    borderColor: ["responsive", "dark", "group-hover", "focus-within", "hover", "focus", "before", "disabled"],
    borderOpacity: [
      "responsive",
      "dark",
      "group-hover",
    ...
    gap: ["responsive"],
    gradientColorStops: ["responsive", "dark", "hover", "focus", "before", "disabled"],
    ...
    pointerEvents: ["responsive", "before", "disabled"],
